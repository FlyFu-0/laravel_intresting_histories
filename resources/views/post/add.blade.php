                ...
                <div class="px-4 py-6 sm:p-8">
                    <div class="grid max-w-2xl grid-cols-1 gap-6 sm:grid-cols-6">
                        ...
                        <div class="col-span-full">
                            ...
                            <p class="mt-3 text-sm/6 text-gray-600">{{__('Write a few sentences about your story')}}.</p>
                        </div>
                    </div>
                    ...
                    <div class="mt-6 space-y-6">
                        <div class="flex gap-3">
                            ...
                            <div class="text-sm/6">
                                <label for="publish" class="font-medium text-gray-900">{{__('Publish')}}</label>
                                <p id="publish-description" class="text-gray-500">{{__('Send to moderation just after save')}}.</p>
                            </div>
                        </div>
                    </div>
                </div>
